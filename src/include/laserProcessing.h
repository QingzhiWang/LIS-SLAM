...
public:
    ...
    deskewFlag(0)
    {
        ...
        // subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>(pretreatmentedCloudTopic, 5, &ImageProjection::cloudHandler, this);

        pubExtractedCloud = nh.advertise<sensor_msgs::PointCloud2> ("lis_slam/deskew/cloud_deskewed", 1);
        pubLaserCloudInfo = nh.advertise<lis_slam::cloud_info> ("lis_slam/deskew/cloud_info", 1);
    ...
    void publishClouds()
    {
        ...
        cloudInfo.cloud_deskewed  = publishRawCloud(&pubExtractedCloud, extractedCloud, cloudHeader.stamp, lidarFrame);
