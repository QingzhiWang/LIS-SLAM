 ...
 public:
  ...
  void calculateTranslation() {
    ...
    pcl::getTranslationAndEulerAngles(
        transIncre, transformCurFrame2PriFrame[3],
        transformCurFrame2PriFrame[4], transformCurFrame2PriFrame[5],
        transformCurFrame2PriFrame[0], transformCurFrame2PriFrame[1],
        transformCurFrame2PriFrame[2]);
  }
  ...
  void updateInitialGuess() {
    ...
    if (cloudInfo.odomAvailable == false && cloudInfo.imuAvailable == false) {
      ...
      Eigen::Affine3f transLast = pcl::getTransformation(
          lastTransformTobeMapped[3], lastTransformTobeMapped[4],
