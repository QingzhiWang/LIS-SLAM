...
map<int, int> loopIndexContainerTest;
...
class SubMapOdometryNode : public SubMapManager<PointXYZIL>
{
 public:
    ...
    void saveKeyFrames()
    {
		...
		keyframeInSubmapIndex.insert(std::make_pair(keyFrameID, subMapID));
...
class SubMapOptmizationNode : public SubMapManager<PointXYZIL> {
 public:
    ...
    void publishGlobalMap()
    {
        ...
        publishLabelCloud(&pubCloudMap, globalMapCloud, timeSubMapInfoStamp, mapFrame);
    }
