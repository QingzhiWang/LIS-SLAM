...
int main(int argc, char** argv)
{
   ...
   subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>(pointCloudTopic, 5, &cloudHandler);
   pubLaserCloud = nh.advertise<sensor_msgs::PointCloud2> ("lis_slam/points_pretreatmented", 1);
