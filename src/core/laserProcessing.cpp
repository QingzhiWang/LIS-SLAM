 ...
 * 
*****************************************/
void LaserProcessing :: findRotation(double pointTime, float *rotXCur, float *rotYCur, float *rotZCur){
 ...
 * 
*****************************************/
PointXYZIRTL LaserProcessing :: deskewPoint(PointXYZIRTL *point, double relTime){
...
void LaserProcessing :: extractFeatures(){
    ...
    pcl::PointCloud<PointXYZIRTL>::Ptr surfaceCloudScan(new pcl::PointCloud<PointXYZIRTL>());
    pcl::PointCloud<PointXYZIRTL>::Ptr surfaceCloudScanDS(new pcl::PointCloud<PointXYZIRTL>());
